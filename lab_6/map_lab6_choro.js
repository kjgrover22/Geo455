  ...
  var legend = L.control({position: 'bottomright'}); // Try the other three corners if you like.
    ...
    legend.onAdd = function (mymap) {
        ...
        var div = L.DomUtil.create('div', 'legend'),
            grades = [51221, 64394, 72903, 84280, 97693]; // The break values to define the intervals of population, note we begin from 0 here

        div.innerHTML = '<b>English Speaking Households <br></b>'; // The legend title (HTML-based), in this case it's Population Density 2011
